    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="lg:sticky lg:top-24 h-fit">
                <h2 class="text-3xl font-bold text-gray-900 mb-6">Completar reserva</h2>
                <div class="bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-100">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">Precio por mes</span>
                            <span class="font-bold text-gray-900" id="base-price" data-price="{{ $casa->precio }}">€ {{ number_format($casa->precio, 0, ',', '.') }}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-3xl shadow-xl p-8 border border-gray-100 relative">
                    <form action="{{ route('bookings.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-sm text-gray-400">Asegúrate de que tus datos coincidan con el DNI.</p>
                        </div>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-100">
                            <div class="flex justify-between items-center mb-6">
                                ...
                                <span class="text-2xl font-bold text-indigo-700" id="total-price">€ {{ number_format($casa->precio, 0, ',', '.') }}</span>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <button type="submit"
                                    ...
                                    Continuar y pagar <i class="fa-solid fa-arrow-right"></i>
                                </button>
...
<script>
    ...
    durationInput.addEventListener('input', function() {
        ...
        totalPriceDisplay.textContent = '€ ' + new Intl.NumberFormat('id-ID').format(total);
    });
</script>
@endsection
